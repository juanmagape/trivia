...
public class HelloController {
    ...
    private void mostrarPregunta() {
        if (numPreguntas < 10 && preguntaActual != null) {
            ...
            // Actualizar dificultad con estilo apropiado
    ...
    protected void onRespuestaClick(ActionEvent e) {
        ...
        // Actualizar puntuacion inmediatamente
        lblPuntosValor.setText(String.valueOf(puntos));

        numPreguntas++;
        cambiarBotones(true);

        // Esperar un momento para mostrar el resultado visual
        new Thread(() -> {
            try {
                Thread.sleep(1200); // Pausa para ver el resultado
            ...
            for (int i = 0; i < 3; i++) {
                try {
                    ...
                    Platform.runLater(() -> {
                        // Restaurar visibilidad de botones si estaban ocultos
